...
def exampleTables():
    ...
    #print(MedicalListDF.groupby(['Patient ID','Age','Sex','Weight (kg)','Medical Issue','Treatment', 'Postcode']).size().reset_index(name='Count'))
    ...
    KValue = GenSupVoterListDF.groupby(['Name','Age','Sex','Address','Party','Postcode']).size().reset_index(name='Count')
    #print(KValue)
